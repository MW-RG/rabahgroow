  ...
  return (
    <div className='mt-5 flex z-10 h-auto'>
      ...
      <div className='w-full'>
        <div className='bg-slate-200 text-blue-500 h-20 pt-10 pl-20 text-3xl font-bold'>{'<'} 회사연혁 {'>'}</div>
        ...
        <div className='flex pt-12 lg:pl-20 sm:pl-10 pr-20 items-center pb-3'>
        ...
        <div className='flex pt-3 pb-12 pl-20 pr-20 bg-blue-500 text-white items-center'>
          <div className='font-bold text-center'>
            <p>2st Generation</p>
            <p>최고의 IT R&D</p>
            <p>서비스 기업으로 성장</p>
