  ...
  return (
    <div className='mt-5 flex z-10 h-auto'>
      ...
      <div className='w-full'>
        <div className='bg-slate-200 text-blue-500 h-20 pt-10 pl-20 text-3xl font-bold'>{'<'} 회사비전 {'>'}</div>
        <div className='bg-slate-200 h-10 pt-3 pl-20 text-red-500 text-3xl font-bold'>VISION 2025</div>
        <div className='bg-slate-200 lg:h-28 sm:h-32 pt-7 pl-20 pr-20 text-xl pb-5'>
        ...
        <div className='bg-white pt-5 text-center'>
          <img alt='img' src={img} className='inline-block' />
        </div>
      </div>
    </div>
  );
